...
class InstrLoadIO(BaseIO):
    """ Instruction load interface from decoder """
...
class InstrLoadMon(Monitor):
    """ Monitors instruction loads from the decoder """
